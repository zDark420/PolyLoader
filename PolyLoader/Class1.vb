...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        ' Dim glossGradient As New LinearGradientBrush(New Rectangle(1, 1, Width - 2, Convert.ToInt32(Height / 2 - 2))) 'Color.FromArgb(80, Color.White), Color.FromArgb(50, Color.White), 90S))
        ' G.FillRectangle(glossGradient, New Rectangle(1, 1, Width - 2, Convert.ToInt32(Height / 2 - 2)))
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Dim glossGradient As New LinearGradientBrush(New Rectangle(1, 1, 13, Convert.ToInt32(Height / 2 - 2)), Color.FromArgb(80, Color.White), Color.FromArgb(50, Color.White), 90S)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        G.DrawString(Text, Font, Brushes.Black, Convert.ToSingle(Width) / 2 - (3 * Text.Length) + 1, 6)
